...
function deleteDoctor($nr) {
    $codednr = mysqli_real_escape_string($nr)    //kintamojo kodavimas saugumo sumetimais
...
function editeDoctor($nr, $vard, $pavard) {
    ...
    $codednr = mysqli_real_escape_string($nr);
    $codedname = mysqli_real_escape_string($vardas);
    $codedlname = mysqli_real_escape_string($pavarde);
