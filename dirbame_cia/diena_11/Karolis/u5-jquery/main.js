...
// console.log("eq(): " ,  elm);
// console.log("[0]: " ,  elm2);
let test1 = $('h2')[2];    //[]  DOM elementas    (neveikia papildomos jquery komandos (pvz prilibdzius .text() mestu errora), bet veikia html???)
console.log(test1);
let test2 = $('h2').eq(2).text();           //jquery obj (veikia visos jquery komandos)
console.log(test2);

$('h2').eq(1).text("22222     222222");
         // WORKS !!!
