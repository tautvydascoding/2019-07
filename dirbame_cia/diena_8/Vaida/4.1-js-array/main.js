...
let arRadauVarda = false; //pradzioje nerades // kai ieskai duomenu reikia susikurti papildoma kintamaji
for (var i = 0; i < names.length; i++) {
//ar stalciuje yra "Rico"

    if ( names[i] == "Rico" ) {
        arRadauVarda = true; //radau varda
       console.log("Rico numeris: ", i );
       break;       // break - nutraukia (viena) for arba while cikla;
       // return;      //kaip ir break nutrauks cikla
...
// if ( !arRadauVarda ) //AR CIA Tiesa, ! pakslausia priesingo dalyko
if (arRadauVarda == false ) { //ar cia ne tiesa
    console.log( "Neapvyko rasti...Bandykite kita zodis");
