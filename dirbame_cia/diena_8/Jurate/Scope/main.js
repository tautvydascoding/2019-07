...
var x = "Globalaus kintamojo tekstas"; // nenaudoti šioje vietoje let, nes tada neveikia this.x komanda ir rašo, jog x yra undefined

function printAntraste(x){
    document.querySelector("body").innerHTML += "<h4>" + x + "</h4>";
    document.querySelector('body').innerHTML += "<h5>" + this.x + "</h5>";
}
