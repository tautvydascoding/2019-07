...
//==========================
 ...
 //======================
 var vardas1 = "Jonas";   // global - kintamasis
 function myName ( vardas1 ) { //  vardas - local kintamasis
     console.log( "vardas" + vardas1);
     console.log("this.vardas - f-jos viduje: ",  this.vardas1);    // this - pasiekia ~global kintamuosius (tavo tecio kintamuosius)
 }
 myName("PETRAS");
//======================TEKSTO ISVEDIMAS===============
...
printStraipsnis("test straipsnis...");


//  1.3 UZDUOTIS
//  iskviesti f-jaS 3 kartus, kad atspausdintu 3 skirtingas antrastes IR 3 straipnsnius:
 // "Lorem1 ....",   "Lorem2 ....",   "Lorem3 ....",
printAntraste("Vasaros vis salteja <br>");
printStraipsnis("lorem1");

printAntraste("Ruduo ateina <br>");
printStraipsnis("lorem2");

printAntraste("Vis dar lis <br>");
