...
//==========================
 ...
 isvesti(999); // nauja reiksme bet funkcija ja konvertuoja, nes joje nurodyta xx = 20
 console.log( "3. xx:", xx);
...
function printStraipsnis(x,y){
    document.querySelector("body").innerHTML += "<h2>" + x + "</h2>" + "<br>" + "<article>" + y + "</article>" + "<br>" + "<br>";
}
printStraipsnis("lorem1", "lor1")
printStraipsnis("lorem2", "lor2")
printStraipsnis("lorem3", "lor3")
//  1.3 UZDUOTIS
