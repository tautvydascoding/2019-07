...
document.write(" Mano tekstas 3  ");
//window.alert("labas");
//alert("Viso");
 // var ivestTekstas = prompt("Ivestkite savo varda");
 // console.log(ivestTekstas);
...
// aukscio nustatymas:
document.querySelector("h1").style.height = "200px"; 		// change the height of a <div> element:
