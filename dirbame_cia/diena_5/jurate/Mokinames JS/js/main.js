...
function printKaina(x){
    document.querySelector('h1').innerHTML = 15.99;
}
printKaina();
...
function kaina() {
    document.querySelector('h2').innerHTML += " 13.49 ";
    document.querySelector('h2').innerHTML += " 13.49 ";
    document.querySelector('h2').innerHTML += 100.05;
}
kaina();
...
function pazymiuVidurkis() {
    ...
    let p2 = 6;
    let p3 = 8;
    let vidurkis = (p + p1 + p2 + p3) / 5;
    document.querySelector('h3').innerHTML = vidurkis;
}
pazymiuVidurkis();
...
function pazymiuVidurkis1(a, b, c, d, f){
    let vidurkis1 = (a + b + c + d + f) / 5;
    document.querySelector('h4').innerHTML = vidurkis1;
}
...
function getVardas(){
    let vardas = "Tomas";
    return document.querySelector('h5').innerHTML = vardas;
}
getVardas();
...
function getVardasPavarde(){
    ...
    return document.querySelector('h6').innerHTML = vardas + pavarde;
}
getVardasPavarde();
...
function getPelnas() {
    ...
    return document.querySelector('h1.uzduotis3').innerHTML = pelnas;
}
getPelnas();
...
function getPelnas1(pajamos1, nuostoliai1){
    let pelnas1 = pajamos1 - nuostoliai1;
    return document.querySelector('h2.uzduotis3').innerHTML = "Jusu pelnas: " + pelnas1;
}
getPelnas1(1250, 1000);
...
jonas = getPazymiuVidurkis2(8,8,8,8,8);
mantas = getPazymiuVidurkis2(7,7,7,7,7);
tomas = getPazymiuVidurkis2(9,9,9,9,9);
tadas = getPazymiuVidurkis2(10,10,10,10,10);
petras = getPazymiuVidurkis2(6,6,6,6,6);

document.querySelector('h3.uzduotis4').innerHTML = "Vieno mokinio vidurkis: " + tomas;
...
function getH1ElementoAukstis() {
    let aukstis = document.querySelector('h1.uzduotis5').style.height = "300px";
    return aukstis;
}
