...
// SVARBU:
document.querySelector('h1').innerHTML = "<b>Antraste</>";
...
// aukscio nustatymas:
document.querySelector("h1").style.height = "100px"; 		// change the height of a <div> element:
...
// iskvietimas ,   jei ivesim kita skaiciu 11 - jis isies i ora, nes kito kintamojo nera
printKaina(15.99, 11);
...
function pazymiuVidurkis1() {
    ...
    let x4 = 6;
    let x5 = 8;
    let vidurkis = (x1 + x2 + x2 + x3 + x4 + x5) / 5;
...
function getVardasPavarde() {
    ...
    // arba
    // let t = (pavarde + " " + vardas)
    // return  t;
}
console.log(   getVardasPavarde()   );

// neveikia, kodel?
// document.querySelector('h2').innerHTML = "getVardasPavarde";
...
console.log(   getPelnas1(5000, 1000)   );
