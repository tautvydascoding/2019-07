...
// isvesti 30 kartu zodi "Azuolas" i konsole  (! bandant tai padaryti, atsiras skaicius 50)
                // tinka  kai salyga nuo tam tikro
for (var i = 15; i < 30; i+=4) {
    document.querySelector("body").innerHTML += ("Azuolas" + " " + i);
}
...
for (var i = 0; i < 20; i++) {
    document.querySelector("artical").innerHTML += ("<h3> 1.2 Azuolas </h3>");
}
...
manoNuotrauka= '<img width="300px" src="img/foto1.jpg" alt="smelio laikrodis">'
