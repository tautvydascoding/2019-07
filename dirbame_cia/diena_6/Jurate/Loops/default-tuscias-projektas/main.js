...
//     // document.querySelector('.tetis').innerHTML = "<h3> Azuolas </h3>";
// }
// 1.1 UZDUOTIS
...
/*
for(let i = 0; i < 10; i++){
    document.querySelector('article').innerHTML += "<h5> Azuolas</h5> ";
}
...
for(let i = 0; i < 10; i++){
    document.querySelector('header').innerHTML += "<p> Apra" + i + "symas</p>";
}
...
for(let b = 0; b < 6; b++){
document.querySelector('div').innerHTML += "<li> elementas" + b + "</li>";
}
...
function print(){
    let tekstas = "atspausdintas su function print()";
    return tekstas;
}
document.querySelector('h5').innerHTML = print();
*/
...
//IDEDAM NUOTRAUKA SU JAVASCRIPT I HTML//
nuotrauka = '<img src="img/portfolio-02.jpg" alt="work"></img>';
for(a = 0; a < 5; a++){
    printX(nuotrauka);
}
